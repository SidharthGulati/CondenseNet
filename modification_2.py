...
def log(log_file_name, app_name="modification_2"):
    """
...
def model(x_image, keep_prob):
    ...
    """
    # Conv-1 layer
    h_pool1 = add_conv_layer(input_dim=[1, 1, 1, 64], output_dim=64, layer_name='conv1', input_tensor=x_image)
    logger.info("Shape of Pool1 = {0}".format(h_pool1.get_shape()))
    # Conv-2 Layer
    h_pool2 = add_conv_layer(input_dim=[1, 1, 64, 128], output_dim=128, layer_name='conv2', input_tensor=h_pool1)
