...
flags.DEFINE_string('logs_dir', '/Users/Sidharth/Documents/AiFi', 'Log file directory')
...
def log(log_file_name, app_name="condenseNet-2"):
    """
...
def condense_module(input_dim, shrink_depth, expand_depth, layer_name, input_tensor):
    """
    This is the main condense module that performs shrink and expand operations.
...
def model(x_image, keep_prob):
    ...
    :param x_image: Input image tensor
    :param keep_prob: Keep Probability of the input data set for regularization.
    """
    # Conv-1 layer
    ...
    # FC-1 layer
    fc_1 = add_fully_connected_layer(input_dim=2 * 2 * 128, output_dim=128, layer_name="fc1",
                                     keep_prob=keep_prob, input_tensor=condensed_layer)
    # FC-2 layer
    pred = add_fully_connected_layer(input_dim=128, output_dim=10, keep_prob=keep_prob, layer_name="fc2",
